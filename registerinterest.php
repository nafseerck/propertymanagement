        ...
        <div class="new-container">
            <header id="navbar">
                <div class="boxed" id="navbar-container">
                    <div class=" clearfix ">
                        <a class="navbar-brand site-logo" href="homePage">
                    ...
                    <nav class="navbar navbar-default megamenu">
                        ...
                        <div class="navbar-collapse collapse" id="defaultmenu">
                            <ul class="nav navbar-nav">
                                <li class="current"><a href="homepage"><i aria-hidden="true" class="fa fa-home"></i> Home</a></li>
                                <li class="dropdown">
                        ...
                        <div class="row intro-block">
                            <div class="col-lg-12 col-md-8 col-sm-8">
                                <div class="panel kforx3">
                                    ...
                                    $sql = "SELECT * FROM registerinterest WHERE `created_by`='$usID'";
                                    ...
                                    <div class="panel-body ">
                                        ...
                                        <table class="table" style="padding-top: 35px;">
                                            <thead class="thead-dark">
                                                <tr>
                                                    ...
                                                    <th scope="col">Total Area (Sq Ft)</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($files as $file) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="row"><?php echo $file['unittype']; ?></td>
                                                        <td><?php echo $file['buildingname']; ?></td>
                                                        <td><?php echo $file['unitname']; ?></td>
                                                        <td><?php echo $file['bedroomnumber']; ?></td>
                                                        <td><?php echo $file['totalarea']; ?></td>
                                                        <td><?php echo $file['totalprice']; ?></td>
                                                        <td><a href="datas/uploaded_files/<?php echo $file['name'] ?>" class="fa fa-file-pdf-o">View</a></td>
                                                        <td><button type="button" class="btn btn-primary">Register Interest</button></td>
