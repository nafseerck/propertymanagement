                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="text" name="moveoutcompany" class="form-control" id="moveoutcompany" value="<?php echo $details_row['moveoutcompany']; ?>"></input>
                                                                                    </div>
                                                                                    <label class="col-sm-2 control-label "> Move Out Company Contact*
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                        <input type="text" name="moveoutcompanycontact" class="form-control" id="moveoutcompanycontact" value="<?php echo $details_row['moveoutcompanycontact']; ?>"></input>
                                                                                    </div>
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> Move Out Date
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="datetime-local" name="moveoutdate" id="moveoutdate" value="<?php echo $details_row['moveoutdate']; ?>">
                                                                                            </input>
                                                                                        </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="containertab1 .d-md-none .d-lg-block ">
                                                                                        <button type="submit" class="btn btn-primary" name="update11">Update</button>
                                                                                    </div>
                                                                                </div>
