                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> No of Resident Pass Required
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                        <select class="form-control" alt="" id="residentpass" maxlength="" name="residentpass">
                                                                                            <option value="<?php $details_row['residentpass']; ?>"><?php echo $details_row['residentpass']; ?></option>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="containertab1 .d-md-none .d-lg-block ">
                                                                                        <button type="submit" class="btn btn-primary" name="update12">Update</button>
                                                                                    </div>
                                                                                </div>
