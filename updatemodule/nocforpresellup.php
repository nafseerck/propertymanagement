...
$details = mysqli_query($con, "SELECT * FROM nocforpresell WHERE `id`='$id_incoming' ");
                                                                        ...
                                                                        <form method="POST">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="col-sm-2 control-label "> Currently Morgaged
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            ...
                                                                                            <option value="<?php echo $details_row['mortgagestatus']; ?>"><?php echo $details_row['mortgagestatus']; ?></option>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            ...
                                                                                            <option value="<?php echo $details_row['buyermortgagerequired']; ?>"><?php echo $details_row['buyermortgagerequired']; ?></option>
                                                                                                <option value="yes">Yes</option>
                                                                                                <option value="no">No</option>
                                                                                            </select>
                                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="containertab1 .d-md-none .d-lg-block ">
                                                                                    <button type="submit" class="btn btn-primary" name="update9">Update</button>
                                                                                </div>
                                                                            </div>
