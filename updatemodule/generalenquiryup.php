                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input class="form-control" id="desctription" name="desctription" value="<?php echo $details_row['desctription']; ?>">
                                                                                        </input>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input class="form-control" id="subject" name="subject" value="<?php echo $details_row['subject']; ?>">
                                                                                        </input>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="containertab1 .d-md-none .d-lg-block ">
                                                                                        <button type="submit" class="btn btn-primary" name="update7">Update</button>
                                                                                    </div>
                                                                                </div>
