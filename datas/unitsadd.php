...
if (isset($_POST['submit'])) {
    ...
    $destination = '../propertyplans/' . $filename;
    ...
    $unittype = mysqli_real_escape_string($con, $_POST['unittype']);
    $buildingname = mysqli_real_escape_string($con, $_POST['buildingname']);
    $unitname = mysqli_real_escape_string($con, $_POST['unitname']);
    $bedroomnumber = mysqli_real_escape_string($con, $_POST['bedroomnumber']);
    $totalarea = mysqli_real_escape_string($con, $_POST['totalarea']);
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx', 'jpg'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO `registerinterest` (`id`,`name`,`unittype`, `buildingname`,`unitname`,`bedroomnumber`,`totalarea`,`totalprice`,`created_by`) VALUES ('','$filename','$unittype','$buildingname','$unitname','$bedroomnumber','$totalarea','$totalprice','$usID')";
                                                                ...
                                                                <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                    <span>
                                                                        ...
                                                                        <form method="POST" enctype="multipart/form-data">
                                                                            <div>
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-2 control-label "> Type Of Unit
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                        <input class="form-control" type="" name="unittype" id="unittype">
                                                                                        </input>
                                                                                    </div>

                                                                                    <label class="col-sm-2 control-label "> Building Name
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> Unit Name
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> Number of Bedrooms
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                        <select class="form-control" alt="" id="bedroomnumber" maxlength="" name="bedroomnumber">
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> Total Area
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                        <input class="form-control" type="text" name="totalarea" id="totalarea">
                                                                                        </input>
                                                                                    </div>

                                                                                    <label class="col-sm-2 control-label "> Price (AED)
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
                                                                                    ...
                                                                                    <label class="col-sm-2 control-label "> Floor Plan
                                                                                        <span class="red">*</span>
                                                                                    </label>
                                                                                    <div class="col-sm-4">
