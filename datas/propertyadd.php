...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `propertydata`(`id`, `propertyname`, `description`) VALUES ('','$propertyname','$description')";
    ...
    if (mysqli_query($con, $sql)) {
        ...
        if ($query_id != '') {
            echo '<script>alert("Thank you for adding the Property. Your property has been successfully Added")</script>';
        }
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" name="propertyname" id="propertyname">
                                                                                            </input>
                                                                                        </div>
