...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['nocforsellposthandover']['propertyname'];
    $currentlymortgaged = $_SESSION['nocforsellposthandover']['currentlymortgaged'];
    $newsellingprice = $_SESSION['nocforsellposthandover']['newsellingprice'];
    $buyertype = $_SESSION['nocforsellposthandover']['buyertype'];
    $buyermortgagestatus = $_SESSION['nocforsellposthandover']['buyermortgagestatus'];
    $applicationtype = $_SESSION['nocforsellposthandover']['applicationtype'];





    $sql = "INSERT INTO `nocforpostsell`(`id`, `propertyname`, `currentlymortgaged`, `newsellingprice`, `buyertype`, `buyermortgagestatus`,`applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$currentlymortgaged','$newsellingprice','$buyertype','$buyermortgagestatus','$applicationtype','$created_date', '$usID')";
    ...
    unset($_SESSION['nocforpostsellhandover']);

    header('location:noc-for-sell-post-handover.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $currentlymortgaged = mysqli_real_escape_string($con, $_POST['currentlymortgaged']);
    $newsellingprice = mysqli_real_escape_string($con, $_POST['newsellingprice']);
    $buyertype = mysqli_real_escape_string($con, $_POST['buyertype']);
    $buyermortgagestatus = mysqli_real_escape_string($con, $_POST['buyermortgagestatus']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);

    $save_to_data = array('propertyname' => $propertyname, 'currentlymortgaged' => $currentlymortgaged, 'newsellingprice' => $newsellingprice, 'buyertype' => $buyertype, 'buyermortgagestatus' => $buyermortgagestatus, 'applicationtype' => $applicationtype, );
    $_SESSION['nocforsellposthandover'] = $save_to_data;
    header('location:noc-for-sell-post-handover.php?step_new=3');
}
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission -Noc For Mortgage</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>NOC for Sell - Post Handover
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>Please submit your application to receive the <strong>No Objection Certificate (NOC) for Property Sale after Handover;</strong> by selecting one of the following options.
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <span style="font-style: italic">
                                                                                        Only application will be online, for collection please visit our Customer Care department in the Sales Center
                                                                                    </span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p><strong>Fee Details
                                                                                        </strong> </p>
                                                                                    <p>AED 1050
                                                                                        <br>AED 1050 + AED 525 (For buyer mortgage application)
                                                                                        <br>
                                                                                        NOC Renewal Fees - AED 525
                                                                                ...
                                                                                <div class="col">
                                                                                    ...
                                                                                    <p><strong>Documents required for Application
                                                                                        </strong></p>
                                                                                    <ul>
                                                                                        <li>Passport with Visa page
                                                                                        </li>
                                                                                        <li>Emirates ID if applicable
                                                                                        </li>
                                                                                        <li>Power of Attorney if applicable
                                                                                        </li>
                                                                                        <li>Mortgage Final Offer Letter(if applicable)
                                                                                        </li>
                                                                                        <li>Company documents – MOU, Trade License, passport for the authorized person if applicable
                                                                                        </li>
                                                                                        <li>
                                                                                            Chilled Water Statement of Account <strong>(SOA)</strong> with zero outstanding as of last billing invoice from ISTA (<strong>Email</strong> : Town.square@ista.com for SOA) - <strong>APPLICABLE ONLY FOR APARTMENTS</strong>
                                                                                        </li>
                                                                                        <li>
                                                                                            Chilled Water Security Deposit receipt from the buyer. Contact ISTA for details (<strong>Email</strong> : Town.square@ista.com ) - <strong>APPLICABLE ONLY FOR APARTMENTS</strong>
                                                                                        </li>
                                                                                ...
                                                                                <div class="col">
                                                                                    ...
                                                                                    <ul>
                                                                                        <li>NOC will be sent to the registered email address.
                                                                                        </li>
                                                                                        <li>NOC is valid for 15 days.
                                                                                        </li>
                                                                                        <li>Fees paid are non-refundable.
                                                                                        </li>
                                                                                        <li>
                                                                                            All outstanding payments must be cleared before applying for this request.
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b>NOC for Sell - Post Handover</b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Noc For Post Sell Handover">Noc For Post Sell Handover</option>
                                                                                            </select>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input type="text" name="newsellingprice" class="form-control" id="newsellingprice"></input>
                                                                                        </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name:</strong> <?php echo $_SESSION['nocforsellposthandover']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type</strong> <?php echo $_SESSION['nocforsellposthandover']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Currently Morgaged :</strong> <?php echo $_SESSION['nocforsellposthandover']['currentlymortgaged']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>New Selling Price</strong> <?php echo $_SESSION['nocforsellposthandover']['newsellingprice']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Buyer Type</strong> <?php echo $_SESSION['nocforsellposthandover']['buyertype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Buyer Type</strong> <?php echo $_SESSION['nocforsellposthandover']['buyermortgagestatus']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
