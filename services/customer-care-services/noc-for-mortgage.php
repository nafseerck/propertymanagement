...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `nameamendment`(`id`, `applicationtype`, `propertyname`, `currentlymortgaged`, `newsellingprice`,`buyertype`,`buyermortgagestatus`,`created_at`,`created_by`) VALUES ('','$applicationtype','$propertyname','$deliverymethod', '$currentlymortgaged','$newsellingprice','$buyertype','$buyermortgagestatus','$created_date','$usID')";
    ...
    if (mysqli_query($con, $sql)) {
        if ($query_id != '') {
            header("location:noc-for-post-sell-handover.php?step=3&data=$query_id#step-3");
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>Noc For Mortgage</strong></b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>Please submit your application to receive the <strong>No Objection Certificate (NOC) for Mortgage Registration;</strong> by selecting one of the following options.
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                    <ul>
                                                                                        <li> Mortgage Registration for completed properties
                                                                                        </li>
                                                                                        <li>
                                                                                            Mortgage Registration for property under construction
                                                                                        </li>
                                                                                    </ul>
                                                                                    <span style="font-style: italic">On approval, you will be required to visit Customer Care to submit originals and collect the NOC.
                                                                                    </span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    ...
                                                                                    <p>Mortgage NOC Fees - AED 525
                                                                                        <br>NOC Renewal - AED 525
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="col">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <li>Mortgage Final Offer Letter
                                                                                        </li>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <select class="form-control" alt="" id="" maxlength="" name="">
                                                                                        <option value="">--None--</option>
                                                                                        <option value="completedproperty">Completed Property</option>
                                                                                        <option value="underconstructionproperty">Under Construction Property</option>
