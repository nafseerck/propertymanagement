...
if (isset($_POST['step_3_submit'])) {
    ...
    $applicationtype = $_SESSION['makeapayment']['applicationtype'];
 
    $propertyname = $_SESSION['makeapayment']['propertyname'];
    $casenumber = $_SESSION['makeapayment']['casenumber'];




    $sql = "INSERT INTO `makeapayment`(`applicationtype`,`propertyname`,`casenumber`,`created_at`,`created_by`) VALUES ('$applicationtype','$propertyname','$casenumber','$created_date','$usID')";
    ...
    header('location:make-a-payment.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $save_to_data = array('applicationtype' => $applicationtype, 'propertyname' => $propertyname, 'casenumber' => $casenumber);
    $_SESSION['makeapayment'] = $save_to_data;
    header('location:make-a-payment.php?step_new=3');
}

// $propertyname = "SELECT `propertyname` FROM `propertydata`";
// $result = mysqli_query($con, $propertyname);
// $propertynames = mysqli_fetch_assoc($result);
                            ...
                            <div class="col-md-12">
                                <section class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Request Submission - Make a payment</h3>
                                    </div>
                                                                    ...
                                                                    <div class="content clearfix">
                                                                        ...
                                                                        <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                            <span>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="col">
                                                                                        <p>Please submit for the following options.
                                                                                        </p>
                                                                                    </div>
                                                                                    <div class="col-sm-4">
                                                                                        <p class="info-form">
                                                                                        <ul>
                                                                                            ...
                                                                                            <li>Other Admin Charges</li>
                                                                                            <li>Title Deed and Processing Fee</li>
                                                                                            <li>Violation / Penalty Charges</li>
                                                                                            <li>Service Fees</li>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Make A Payment - Late Payment Fees">Make a Payment - Late Payment Fees</option>
                                                                                                <option value="Make A Payment - Other Admin Charges">Make a Payment - Other Admin Charges</option>
                                                                                                <option value="Make A Payment - Pre Title Deed and Processing Fees">Make a Payment - Pre Title Deed and Processing Fees</option>
                                                                                                <option value="Make A Payment - Service Fees">Make a Payment - Service Fees</option>
                                                                                                <option value="Make A Payment - Title Deed And Processing Fees">Make a Payment - Title Deed and Processing Fees</option>
                                                                                                <option value="Make A Payment - Violation / Penalty Changes">Make a Payment - Violation / Penalty Changes</option>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['makeapayment']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['makeapayment']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
