...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['nocforpresellhandover']['propertyname'];
    $currentlymortgaged = $_SESSION['nocforpresellhandover']['mortgagestatus'];
    $newsellingprice = $_SESSION['nocforpresellhandover']['newsellingprice'];
    $buyertype = $_SESSION['nocforpresellhandover']['buyertype'];
    $buyermortgagestatus = $_SESSION['nocforpresellhandover']['buyermortgagerequired'];
    $applicationtype = $_SESSION['nocforpresellhandover']['applicationtype'];





    $sql = "INSERT INTO `nocforpresell`(`id`, `propertyname`, `mortgagestatus`, `newsellingprice`, `buyertype`, `buyermortgagerequired`,`applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$currentlymortgaged','$newsellingprice','$buyertype','$buyermortgagestatus','$applicationtype','$created_date','$usID')";
    ...
    unset($_SESSION['nocforpresellhandover']);

    header('location:noc-for-sell-pre-handover.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $currentlymortgaged = mysqli_real_escape_string($con, $_POST['mortgagestatus']);
    ...
    $buyermortgagestatus = mysqli_real_escape_string($con, $_POST['buyermortgagerequired']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);

    $save_to_data = array('propertyname' => $propertyname, 'mortgagestatus' => $currentlymortgaged, 'newsellingprice' => $newsellingprice, 'buyertype' => $buyertype, 'buyermortgagerequired' => $buyermortgagestatus, 'applicationtype' => $applicationtype);
    $_SESSION['nocforpresellhandover'] = $save_to_data;
    header('location:noc-for-sell-pre-handover.php?step_new=3');
}
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission -Noc For Sell Pre Handover</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>NOC for Sell - Pre Handover
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>Please submit your application to receive the <strong>No Objection Certificate (NOC) for Property Sale prior to Unit Completion;</strong> by selecting one of the following options.
                                                                                    </p>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    ...
                                                                                    <p>Noc Fees - AED 5250
                                                                                        <br>AED 5250 + AED 525 (For buyer mortgage application)
                                                                                        <br>
                                                                                        Renewal Fees - AED 525
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="mortgagestatus" maxlength="" name="mortgagestatus">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Noc For Pre Sell Handover">Noc for Pre Sell Handover</option>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="buyermortgagerequired" maxlength="" name="buyermortgagerequired">
                                                                                                <option value="none">--None--</option>
                                                                                                <option value="yes">Yes</option>
                                                                                                <option value="no">No</option>
                                                                                            </select>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name:</strong> <?php echo $_SESSION['nocforpresellhandover']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Currently Morgaged :</strong> <?php echo $_SESSION['nocforpresellhandover']['mortgagestatus']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>New Selling Price</strong> <?php echo $_SESSION['nocforpresellhandover']['newsellingprice']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Buyer Type</strong> <?php echo $_SESSION['nocforpresellhandover']['buyertype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Buyer Mortgage Required :</strong> <?php echo $_SESSION['nocforpresellhandover']['buyermortgagerequired']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type</strong> <?php echo $_SESSION['nocforpresellhandover']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
