...
if (isset($_POST['step_3_submit'])) {
    ...
    $applicationtype = $_SESSION['asifeeveedinteaishwaryam']['applicationtype'];

    $subject = $_SESSION['asifeeveedinteaishwaryam']['subject'];
    $description = $_SESSION['asifeeveedinteaishwaryam']['description'];
    $propertydatanew = $_SESSION['asifeeveedinteaishwaryam']['propertyname'];
    $casenumber = $_SESSION['asifeeveedinteaishwaryam']['casenumber'];




    $sql = "INSERT INTO `generalenquiry`(`applicationtype`, `subject`, `desctription`, `propertyname`, `casenumber`, `created_at`,`created_by`) VALUES ('$applicationtype','$subject','$description','$propertydatanew', '$casenumber', '$created_date','$usID')";
    ...
    unset($_SESSION['asifeeveedinteaishwaryam']);

    header('location:general-enquiry.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['asifeeveedinteaishwaryam'] = $save_to_data;
    header('location:general-enquiry.php?step_new=3');
}
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - General Enquiry</h3>
                                </div>
                                                                ...
                                                                <div class="content clearfix">
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>Please submit your application for <strong>General Enquiry</strong>; by selecting one / more of the following options.
                                                                                    </p>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['asifeeveedinteaishwaryam']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['asifeeveedinteaishwaryam']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Subject</strong> <?php echo $_SESSION['asifeeveedinteaishwaryam']['subject']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Description</strong> <?php echo $_SESSION['asifeeveedinteaishwaryam']['description']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
