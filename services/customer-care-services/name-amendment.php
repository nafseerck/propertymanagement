...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname1 = $_SESSION['nameamendment']['propertyname'];
    $applicationtype = $_SESSION['nameamendment']['applicationtype'];
    $deliverymethod = $_SESSION['nameamendment']['deliverymethod'];
    ...
    $sql = "INSERT INTO `nameamendment`(`id`, `applicationtype`, `propertyname`,`deliverymethod`, `created_at`,`created_by`) VALUES ('','$applicationtype','$propertyname1','$deliverymethod', '$created_date','$usID')";
    ...
    header('location:name-amendment.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $propertyname1 = mysqli_real_escape_string($con, $_POST['propertyname']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);
    $deliverymethod = mysqli_real_escape_string($con, $_POST['deliverymethod']);


    $save_to_data = array('propertyname' => $propertyname1, 'applicationtype' => $applicationtype, 'deliverymethod' => $deliverymethod);
    $_SESSION['nameamendment'] = $save_to_data;
    header('location:name-amendment.php?step_new=3');
}
...
<!-- if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `nameamendment`(`id`, `applicationtype`, `propertyname`, `deliverymethod`) VALUES ('','$applicationtype','$propertyname','$deliverymethod')";


    if (mysqli_query($con, $sql)) {
        $query_id = mysqli_insert_id($con);
        if ($query_id != '') {
            header("location:name-amendment.php?step=3&data=$query_id#step-3");
        }
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - Name Amendment</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>Name amendment / Reprint SPA / Lost SPA</strong></b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                    <ul>
                                                                                        <li>Lost SPA : <span style="color: red;">Police Report</span></li>
                                                                                        <li>Change of Address Details: <span style="color: red;">Submission of original SPA upon new SPA collection
                                                                                            </span></li>
                                                                                        <li>Name Amendment :<span style="color: red;">Old and new passport copy</span>
                                                                                        </li>
                                                                                    </ul>
                                                                                    </p>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>Admin Fee Details </p>
                                                                                </div>

                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                    <ul>
                                                                                        <li>Lost SPA : <span style="color: red;">3150</span></li>
                                                                                        <li>Change of Address Details: <span style="color: red;">525
                                                                                            </span></li>
                                                                                        <li>Name Amendment :<span style="color: red;">525</span>
                                                                                        </li>
                                                                                    </ul>
                                                                                    </p>
                                                                                </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['nameamendment']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['nameamendment']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Delivery Method</strong> <?php echo $_SESSION['nameamendment']['deliverymethod']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            <form method="POST">
                                                                                ...
                                                                                <div class="containertab1 .d-md-none .d-lg-block ">
                                                                                            <a href="#step-1" class="btn btn-primary">Prev</a>
