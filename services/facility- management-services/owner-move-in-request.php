...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname =  $_SESSION['ownermoveinrequest']['propertyname'];
    $moveindate =  $_SESSION['ownermoveinrequest']['moveindate'];
    $occupants =  $_SESSION['ownermoveinrequest']['occupants'];
    $householdhelper =  $_SESSION['ownermoveinrequest']['householdhelper'];
    $accesscard1 =  $_SESSION['ownermoveinrequest']['accesscard1'];
    $accesscard2 =  $_SESSION['ownermoveinrequest']['accesscard2'];
    $accesscard3 =  $_SESSION['ownermoveinrequest']['accesscard3'];
    $accesscard4 =  $_SESSION['ownermoveinrequest']['accesscard4'];
    $parkingcard1 =  $_SESSION['ownermoveinrequest']['parkingcard1'];
    $parkingcard2 =  $_SESSION['ownermoveinrequest']['parkingcard2'];
    $parkingcard3 =  $_SESSION['ownermoveinrequest']['parkingcard3'];
    $parkingcard4 =  $_SESSION['ownermoveinrequest']['parkingcard4'];
    $vehicleplatenumber1 =  $_SESSION['ownermoveinrequest']['vehicleplatenumber1'];
    $vehicleplatenumber2 =  $_SESSION['ownermoveinrequest']['vehicleplatenumber2'];
    $vehicleplatenumber3 =  $_SESSION['ownermoveinrequest']['vehicleplatenumber3'];
    $vehicleplatenumber4 =  $_SESSION['ownermoveinrequest']['vehicleplatenumber4'];
    $applicationtype =  $_SESSION['ownermoveinrequest']['applicationtype'];




    $sql = "INSERT INTO `ownermoveinrequest`(`id`, 
    `propertyname`, `moveindate`, `occupants`, 
    `householdhelper`, `accesscard1`, `accesscard2`, 
    `accesscard3`, `accesscard4`, `parkingcard1`, 
    `parkingcard2`, `parkingcard3`, `parkingcard4`, 
    `vehicleplatenumber1`, `vehicleplatenumber2`, 
    `vehicleplatenumber3`, `vehicleplatenumber4`,`applicationtype`,`created_at`,`created_by`) 
    VALUES ('','$propertyname',
    '$moveindate','$occupants',
    '$householdhelper','$accesscard1',
    '$accesscard2','$accesscard3','$accesscard4',
    '$parkingcard1','$parkingcard2','$parkingcard3',
    '$parkingcard4','$vehicleplatenumber1',
    '$vehicleplatenumber2','$vehicleplatenumber3',
    '$vehicleplatenumber4','$applicationtype','$created_date','$usID')";
...
header('location:owner-move-in-request.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $moveindate = mysqli_real_escape_string($con, $_POST['moveindate']);
    $occupants = mysqli_real_escape_string($con, $_POST['occupants']);
    $householdhelper = mysqli_real_escape_string($con, $_POST['householdhelper']);
    $accesscard1 = mysqli_real_escape_string($con, $_POST['accesscard1']);
    $accesscard2 = mysqli_real_escape_string($con, $_POST['accesscard2']);
    $accesscard3 = mysqli_real_escape_string($con, $_POST['accesscard3']);
    $accesscard4 = mysqli_real_escape_string($con, $_POST['accesscard4']);
    $parkingcard1 = mysqli_real_escape_string($con, $_POST['parkingcard1']);
    $parkingcard2 = mysqli_real_escape_string($con, $_POST['parkingcard2']);
    $parkingcard3 = mysqli_real_escape_string($con, $_POST['parkingcard3']);
    $parkingcard4 = mysqli_real_escape_string($con, $_POST['parkingcard4']);
    $vehicleplatenumber1 = mysqli_real_escape_string($con, $_POST['vehicleplatenumber1']);
    $vehicleplatenumber2 = mysqli_real_escape_string($con, $_POST['vehicleplatenumber2']);
    $vehicleplatenumber3 = mysqli_real_escape_string($con, $_POST['vehicleplatenumber3']);
    $vehicleplatenumber4 = mysqli_real_escape_string($con, $_POST['vehicleplatenumber4']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);




    $save_to_data = array('propertyname' => $propertyname, 'moveindate' => $moveindate, 'occupants' => $occupants, 'householdhelper' => $householdhelper,'accesscard1' => $accesscard1,
    'accesscard2' => $accesscard2,'accesscard3' => $accesscard3,'accesscard4' => $accesscard4,'parkingcard1' => $parkingcard1,'parkingcard2' => $parkingcard2,
    'parkingcard3' => $parkingcard3,'parkingcard4' => $parkingcard4,'vehicleplatenumber1' => $vehicleplatenumber1,'vehicleplatenumber2' => $vehicleplatenumber2,'vehicleplatenumber3' => $vehicleplatenumber3,
    'vehicleplatenumber4' => $vehicleplatenumber4, 'applicationtype' => $applicationtype);
    $_SESSION['ownermoveinrequest'] = $save_to_data;
    header('location:owner-move-in-request.php?step_new=3');
}
?>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - Owner Move In Request</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>Owner Move-in Request
                                                                                            </strong></b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <ul>
                                                                                        <li>
                                                                                            Please submit your application to obtain approvals for Move-in Process
                                                                                        </li>
                                                                                        <li>
                                                                                            The request for Move-in will be reviewed and an approval / decline letter will be issued thereafter.
                                                                                        </li>
                                                                                        <li>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="datetime-local" name="moveindate" id="moveindate">
                                                                                            </input>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" id="occupants" name="occupants">
                                                                                            </input>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="accesscard1" name="accesscard1">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Access Card 2
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="accesscard2" name="accesscard2">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Access Card 3
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="accesscard3" name="accesscard3">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Access Card 4
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="accesscard4" name="accesscard4">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Parking Card 1
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="parkingcard1" name="parkingcard1">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Parking Card 2
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="parkingcard2" name="parkingcard2">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Parking Card 3
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="parkingcard3" name="parkingcard3">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                            Parking Card 4
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="parkingcard4" name="parkingcard4">
                                                                                            </input>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="vehicleplatenumber1" name="vehicleplatenumber1">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="vehichleplatenumber2" name="vehicleplatenumber2">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="vehicleplatenumber3" name="vehicleplatenumber3">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="" id="vehicleplatenumber4" name="vehicleplatenumber4">
                                                                                            </input>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['ownermoveinrequest']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['ownermoveinrequest']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Move In Date</strong> <?php echo $_SESSION['ownermoveinrequest']['moveindate']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>No of occupants</strong> <?php echo $_SESSION['ownermoveinrequest']['occupants']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Need House Hold Helpers ? </strong> <?php echo $_SESSION['ownermoveinrequest']['householdhelper']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Access Card 1 </strong> <?php echo $_SESSION['ownermoveinrequest']['accesscard1']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Access Card 2 </strong> <?php echo $_SESSION['ownermoveinrequest']['accesscard2']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Access Card 3 </strong> <?php echo $_SESSION['ownermoveinrequest']['accesscard3']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Access Card 4 </strong> <?php echo $_SESSION['ownermoveinrequest']['accesscard4']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Parking Card 1 </strong> <?php echo $_SESSION['ownermoveinrequest']['parkingcard1']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Parking Card 2 </strong> <?php echo $_SESSION['ownermoveinrequest']['parkingcard2']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Parking Card 3 </strong> <?php echo $_SESSION['ownermoveinrequest']['parkingcard3']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Parking Card 4 </strong> <?php echo $_SESSION['ownermoveinrequest']['parkingcard4']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Vehicle Plate Number 1</strong> <?php echo $_SESSION['ownermoveinrequest']['vehicleplatenumber1']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Vehicle Plate Number 2</strong> <?php echo $_SESSION['ownermoveinrequest']['vehicleplatenumber2']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Vehicle Plate Number 3 </strong> <?php echo $_SESSION['ownermoveinrequest']['vehicleplatenumber3']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Vehicle Plate Number 4 </strong> <?php echo $_SESSION['ownermoveinrequest']['vehicleplatenumber4']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
