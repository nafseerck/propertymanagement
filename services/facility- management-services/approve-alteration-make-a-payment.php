...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['approvealteration']['propertyname'];
    $applicationtype = $_SESSION['approvealteration']['applicationtype'];



    $sql = "INSERT INTO `approvealteration`(`id`, `propertyname`, `applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$applicationtype','$created_date','$usID')";
    ...
    unset($_SESSION['approvealteration']);

    header('location:approve-alteration-make-a-payment.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $save_to_data = array('propertyname' => $propertyname, 'applicationtype' => $applicationtype);
    $_SESSION['approvealteration'] = $save_to_data;
    header('location:approve-alteration-make-a-payment.php?step_new=3');
}
?>
                                                                        ...
                                                                        <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                            <span>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <p class="info-form">
                                                                                            <b><strong>Approve Alteration - Make a Payment</strong></b>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="col">
                                                                                        <p> Please submit your application for obtain approvals for <strong>Approve Alteration - Fee Payment</strong>; by selecting one of the following options:
                                                                                        </p>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <ul>
                                                                                            ...
                                                                                            <li>Landscaping/Home Improvements</li>
                                                                                        </ul>

                                                                                        </p>
                                                                                        <p>
                                                                                            Please provide the ‘Request Number’ provided at the time of submission and approval of the Alteration Request Form.

                                                                                        </p>

                                                                                        <ul>
                                                                                            <li>
                                                                                                The No Objection Certificate (NOC) will be issued upon completion of payment within 7-14 days.
                                                                                            </li>
                                                                                            <li>
                                                                                                Any authority approval required for alterations will be the responsibility of Owner.
                                                                                            </li>

                                                                                        </ul>

                                                                                        <p><strong>Alteratiion Fees: </strong></p>
                                                                                        <ul>
                                                                                            <li>
                                                                                                Minor Alteration Fees (nonrefundable) 1050 AED

                                                                                            </li>
                                                                                            <li>
                                                                                                Major Alteration Fees (nonrefundable) 2100 AED

                                                                                            </li>
                                                                                            <li>
                                                                                                Refundable Security Deposit (Major alteration) 5000 AED

                                                                                            </li>
                                                                                        </ul>
                                                                                        <p><strong>Entry Pass Fees : </strong></p>
                                                                                        <ul>
                                                                                            <li>
                                                                                                Entry Pass (1 month) 160 AED
                                                                                            </li>
                                                                                            <li>
                                                                                                Entry Pass (2 months) 315 AED
                                                                                            </li>
                                                                                            <li>
                                                                                                Entry Pass (3 months) 525 AED
                                                                                            </li>
                                                                                            <li>
                                                                                                Entry Pass (6 months) 790 AED

                                                                                            </li>
                                                                                            <li>
                                                                                                Entry Pass ( 1 Year ) 1,050 AED
                                                                                ...
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th scope="row">Minor Alteration Fee - 3 Months Entry Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>Minor Alteration Fee and 3 Months Entry Pass </td>
                                                                                            <td>1575.00 AED</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row">Major Alteration Fee - 1 Months Entry Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>Including 5,000 AED Refundable Security Deposit </td>
                                                                                            <td>7260.00 AED</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row">
                                                                                                Minor Alteration Fee - 2 Months Entry Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>Minor Alteration Fee and 2 Months Entry Pass </td>
                                                                                            <td>1365.00 AED</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row">
                                                                                                Major Alteration Fee - 3 Months Entry Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>
                                                                                                Including 5,000 AED Refundable Security Deposit </td>
                                                                                            <td>7625.00 AED
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row">
                                                                                                Landscaping/Home Improvements - 1 Month Entry Pass
                                                                                            </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>
                                                                                                Landscaping/Home Improvements - 1 Month Entry Pass </td>
                                                                                            <td>160.00 AED
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row">
                                                                                                Major Alteration Fee - 1 Months Entry Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>
                                                                                                Minor Alteration Fee and 1 Month Entry Pass </td>
                                                                                            <td>1210.00 AED
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th scope="row">
                                                                                                Major Alteration Fee + 2 Months Pass </th>
                                                                                            <td>Alteration</td>
                                                                                            <td>
                                                                                                Including 5,000 AED Refundable Security Deposit </td>
                                                                                            <td>7415.00 AED
                                                                        ...
                                                                        <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                            <span>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <p class="info-form">
                                                                                            <b>Approve Alteration - Make a payment</b>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                                                                                    ...
                                                                                                                                    <td class="attributes_content">
                                                                                                                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                            <tr>
                                                                                                                                                <td class="attributes_item">
                                                                                                                                                    <span class="f-fallback">
                                                                                                                                                        <strong>Property Name:</strong> <?php echo $_SESSION['approvealteration']['propertyname']; ?>
                                                                                                                                                    </span>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td class="attributes_item">
                                                                                                                                                    <span class="f-fallback">
                                                                                                                                                        <strong>Application Type </strong> <?php echo $_SESSION['approvealteration']['applicationtype']; ?>
                                                                                                                                                    </span>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                        ...
                                                                        <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                            <span>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <p class="info-form">
                                                                                            <b>Approve alteration - Make A Request</b>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                                <h3> Service Requirements</h3>
