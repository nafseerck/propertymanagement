...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['ownermoveoutrequest']['propertyname'];
    $moveoutdate = $_SESSION['ownermoveoutrequest']['moveoutdate'];
    $moveoutcompany = $_SESSION['ownermoveoutrequest']['moveoutcompany'];
    $moveoutcompanycontact = $_SESSION['ownermoveoutrequest']['moveoutcompanycontact'];
    $applicationtype = $_SESSION['ownermoveoutrequest']['applicationtype'];





    $sql = "INSERT INTO `ownermoveoutrequest`(`id`, `propertyname`, `moveoutdate`, `moveoutcompany`, `moveoutcompanycontact`,`applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$moveoutdate','$moveoutcompany','$moveoutcompanycontact','$applicationtype','$created_date','$usID')";
    ...
    header('location:owner-move-out-request.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $moveoutdate = mysqli_real_escape_string($con, $_POST['moveoutdate']);
    $moveoutcompany = mysqli_real_escape_string($con, $_POST['moveoutcompany']);
    $moveoutcompanycontact = mysqli_real_escape_string($con, $_POST['moveoutcompanycontact']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);



    $save_to_data = array('propertyname' => $propertyname, 'moveoutdate' => $moveoutdate, 'moveoutcompany' => $moveoutcompany, 'moveoutcompanycontact' => $moveoutcompanycontact, 'applicationtype' => $applicationtype);
    $_SESSION['ownermoveoutrequest'] = $save_to_data;
    header('location:owner-move-out-request.php?step_new=3');
}
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - Owner Move Out Request</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>Owner Move-Out Request
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>
                                                                                        To ensure a smooth ‘Move Out’ experience, raise the move-out request and give us two working days prior to your move.
                                                                                        <br>Please be assured that any information you give us will remain confidential and shall be used for community level communications only.
                                                                                    </p>


                                                                                    <h4>Gate Access :</h4>
                                                                                    <p>
                                                                                        Owners are responsible for collecting gate access cards or remotes from the tenants who are moving out.
                                                                                        <br>
                                                                                        Access cards should not be transferred to or handed over to anybody else apart from the registered occupants.
                                                                                    </p>

                                                                                    <h4>Access Card Details : </h4>
                                                                                    <p>
                                                                                        Owners are responsible for collecting passes from the tenants who are moving out.
                                                                                        <br>
                                                                                        Access cards should not be transferred to or handed over to anybody else apart from the registered occupants.
                                                                                    </p>
                                                                                    <p>
                                                                                        Nshama / Townsquare Dubai management is not responsible for the condition or state of the unit at the time of move out. All the keys and cards must be
                                                                                        <br>submitted back to the home owner and Community Management team shall not be responsible for any missing asset at the time of move out.
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label class="col-sm-2 control-label "> Move Out Date
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="datetime-local" id="moveoutdate" name="moveoutdate">
                                                                                            </input>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Owner Move Out Request">Owner Move Out Request</option>
                                                                                             
                                                                                            </select>
                                                                                        </div>

                                                                                        <label class="col-sm-2 control-label "> Move Out Company
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" name="moveoutcompany" id="moveoutcompany">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Move Out Company Contact
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" name="moveoutcompanycontact" id="moveoutcompanycontact">
                                                                                            </input>
                                                                                        </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['ownermoveoutrequest']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type :</strong> <?php echo $_SESSION['ownermoveoutrequest']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Move Out Date</strong> <?php echo $_SESSION['ownermoveoutrequest']['moveoutdate']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Move Out Company</strong> <?php echo $_SESSION['ownermoveoutrequest']['moveoutcompany']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Move Out Company Contact</strong> <?php echo $_SESSION['ownermoveoutrequest']['moveoutcompanycontact']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
