...
if (isset($_POST['step_3_submit'])) {
    ...
    $applicationtype = $_SESSION['fmgenericissue']['applicationtype'];
    $subject = $_SESSION['fmgenericissue']['subject'];
    $description = $_SESSION['fmgenericissue']['description'];
    $propertyname = $_SESSION['fmgenericissue']['propertyname'];





    $sql = "INSERT INTO `fmgenericissue`(`id`, `applicationtype`, `subject`, `description`,`propertyname`, `created_at`,`created_by`) VALUES ('','$applicationtype','$subject','$description','$propertyname','$created_date','$usID')";
    ...
    header('location:fm-generic-issues.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $save_to_data = array('applicationtype' => $applicationtype, 'subject' => $subject, 'description' => $description, 'propertyname' => $propertyname, );
    $_SESSION['fmgenericissue'] = $save_to_data;
    header('location:fm-generic-issues.php?step_new=3');
}
?>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - FM Generic Issues</h3>
                                </div>
                                                                ...
                                                                <div class="content clearfix">
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p> Please submit your application for generic issue related to <strong>Facility Management Processes</strong>; by selecting one of the following options:
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                            <option value="Generic Issue">Generic Issue</option>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['fmgenericissue']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Subject</strong> <?php echo $_SESSION['fmgenericissue']['subject']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Description</strong> <?php echo $_SESSION['fmgenericissue']['description']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
