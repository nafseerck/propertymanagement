...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['fmaccesscard']['propertyname'];
    $applicationtype = $_SESSION['fmaccesscard']['applicationtype'];
    $applicationreason = $_SESSION['fmaccesscard']['applicationreason'];


    $sql = "INSERT INTO `fmaccesscard` (`propertyname`,`applicationtype`,`applicationreason`,`created_at`,`created_by`) VALUES ('$propertyname','$applicationtype','$applicationreason','$created_date',$usID)";
    ...
    header('location:fm-access-card-related.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $applicationreason = mysqli_real_escape_string($con, $_POST['applicationreason']);



    $save_to_data = array('propertyname' => $propertyname, 'applicationtype' => $applicationtype, 'applicationreason' => $applicationreason);
    $_SESSION['fmaccesscard'] = $save_to_data;
    header('location:fm-access-card-related.php?step_new=3');
}
?>
...
<head>
    ...
    <link href="../../assets/css/newstyle1.css" rel="stylesheet" type="text/css" />
    <link href="../../assets/css/newstyle2.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - FM Access Card Related</h3>
                                </div>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>FM - Access Card related
                                                                                            </strong></b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p> Please submit your application for obtain approvals for <strong>Access Cards</strong>; by selecting one of the following options:
                                                                                    </p>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <p class="info-form">
                                                                                    ...
                                                                                    <p>
                                                                                        Please select one of the following Reasons for your application :
                                                                                    </p>
                                                                                    <ul>
                                                                                        <li>
                                                                                            Lost </li>
                                                                                    ...
                                                                                    <p>All Charges Mentioned below are inclusive of 5% VAT
                                                                                    <p>
                                                                                    <p><strong> Fees: </strong><br><strong>Access Card :</strong></br></p>
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <th scope="row">Access Card - Lost - Service Charges </th>
                                                                                        <td>Access Details</td>
                                                                                        <td>105.00 AED</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th scope="row">Remote - Replacement - Service Charges </th>
                                                                                        <td>Access Details</td>
                                                                                        <td>105.00 AED</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th scope="row">Remote - Lost - Service Charges </th>
                                                                                        <td>Access Details</td>
                                                                                        <td>105.00 AED</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th scope="row">Access Card - Replacement - Service Charges </th>
                                                                                        <td>Access Details</td>
                                                                                        <td>105.00 AED</td>
                                                                                    </tr>
                                                                                </tbody>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name:</strong> <?php echo $_SESSION['fmaccesscard']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type </strong> <?php echo $_SESSION['fmaccesscard']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Reason </strong> <?php echo $_SESSION['fmaccesscard']['applicationreason']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
