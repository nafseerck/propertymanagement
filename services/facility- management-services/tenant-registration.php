...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['tenantregistration']['propertyname'];
    $tenantfirstname = $_SESSION['tenantregistration']['tenantfirstname'];
    $tenantlastname = $_SESSION['tenantregistration']['tenantlastname'];
    $tenantemailid = $_SESSION['tenantregistration']['tenantemailid'];
    $tenantejarinumber = $_SESSION['tenantregistration']['tenantejarinumber'];
    $tenantejariissuedate = $_SESSION['tenantregistration']['tenantejariissuedate'];
    $tenantejariexpirydate = $_SESSION['tenantregistration']['tenantejariexpirydate'];
    $contractamount = $_SESSION['tenantregistration']['contractamount'];
    $applicationtype = $_SESSION['tenantregistration']['applicationtype'];





    $sql = "INSERT INTO `tenantregistration`
    (`id`, `propertyname`, 
    `tenantfirstname`, `tenantlastname`,
    `tenantemailid`,`tenantejarinumber`,
    `tenantejariissuedate`,
    `tenantejariexpirydate`,`contractamount`,`created_at`,`applicationtype`,`created_by`
    ) 
    VALUES 
    ('','$propertyname',
    '$tenantfirstname',
    '$tenantlastname','$tenantemailid',
    '$tenantejarinumber','$tenantejariissuedate',
    '$tenantejariexpirydate','$contractamount','$created_date','$applicationtype','$usID')";
    ...
    unset($_SESSION['tenantregistration']);

    header('location:tenant-registration.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $tenantfirstname = mysqli_real_escape_string($con, $_POST['tenantfirstname']);
    $tenantlastname = mysqli_real_escape_string($con, $_POST['tenantlastname']);
    $tenantemailid = mysqli_real_escape_string($con, $_POST['tenantemailid']);
    $tenantejarinumber = mysqli_real_escape_string($con, $_POST['tenantejarinumber']);
    $tenantejariissuedate = mysqli_real_escape_string($con, $_POST['tenantejariissuedate']);
    $tenantejariexpirydate = mysqli_real_escape_string($con, $_POST['tenantejariexpirydate']);
    $contractamount = mysqli_real_escape_string($con, $_POST['contractamount']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);



    $save_to_data = array(
        'propertyname' => $propertyname, 'tenantfirstname' => $tenantfirstname, 'tenantlastname' => $tenantlastname, 'tenantemailid' => $tenantemailid,'applicationtype' => $applicationtype,
        'tenantejarinumber' => $tenantejarinumber, 'tenantejariissuedate' => $tenantejariissuedate, 'tenantejariexpirydate' => $tenantejariexpirydate, 'contractamount' => $contractamount

    );
    $_SESSION['tenantregistration'] = $save_to_data;
    header('location:tenant-registration.php?step_new=3');
}
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Request Submission - Tenant Registration</h3>
                                </div>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label class="col-sm-2 control-label "> Tenant First Name
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="text" id="tenantfirstname" name="tenantfirstname">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Tenant Last Name
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="text" id="tenantlastname" name="tenantlastname">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Tenant Email id
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" id="tenantemailid" name="tenantemailid">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Tenant Ejari Number
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" id="tenantejarinumber" name="tenantejarinumber">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Tenant Ejari Issue Date
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="datetime-local" name="tenantejariissuedate" id="tenantejariissuedate">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Tenant Ejari Expiry Date
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" type="datetime-local" name="tenantejariexpirydate" id="tenantejariexpirydate">
                                                                                            </input>
                                                                                        </div>
                                                                                        <label class="col-sm-2 control-label "> Contract Amount
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                            <input class="form-control" name="contractamount" id="contractamount">
                                                                                            </input>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['tenantregistration']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant First Name</strong> <?php echo $_SESSION['tenantregistration']['tenantfirstname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant Last Name</strong> <?php echo $_SESSION['tenantregistration']['tenantlastname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant Email Id</strong> <?php echo $_SESSION['tenantregistration']['tenantemailid']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant Ejari Number</strong> <?php echo $_SESSION['tenantregistration']['tenantejarinumber']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant Ejari Issue Date</strong> <?php echo $_SESSION['tenantregistration']['tenantejariissuedate']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Tenant Ejari Expiry Datae</strong> <?php echo $_SESSION['tenantregistration']['tenantejariexpirydate']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Contract Amount</strong> <?php echo $_SESSION['tenantregistration']['contractamount']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
