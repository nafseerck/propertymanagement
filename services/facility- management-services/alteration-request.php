...
if (isset($_POST['step_3_submit'])) {
    ...
    $applicationtype = $_SESSION['alterationrequest']['applicationtype'];
    $alterationduration = $_SESSION['alterationrequest']['alterationduration'];
    $alterationpurpose = $_SESSION['alterationrequest']['alterationpurpose'];
    $description = $_SESSION['alterationrequest']['description'];




    $sql = "INSERT INTO `alterationrequest`(`id`, `propertyname`, `applicationtype`, `alterationduration`, `alterationpurpose`, `description`,`created_at`,`created_by`) VALUES ('','$propertyname','$applicationtype','$alterationduration','$alterationpurpose','$description','$created_date','$usID')";
    ...
    header('location:alteration-request.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $alterationduration = mysqli_real_escape_string($con, $_POST['alterationduration']);
    $alterationpurpose = mysqli_real_escape_string($con, $_POST['alterationpurpose']);
    $description = mysqli_real_escape_string($con, $_POST['description']);

    $save_to_data = array('propertyname' => $propertyname, 'applicationtype' => $applicationtype, 'alterationduration' => $alterationduration, 'alterationpurpose' => $alterationpurpose, 'description' => $description);
    $_SESSION['alterationrequest'] = $save_to_data;
    header('location:alteration-request.php?step_new=3');
}
?>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <p class="info-form">
                                                                                        <b><strong>Alteratrion Request</strong></b>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p> Please submit your application for obtain approvals for <strong>Alteration Requests</strong>; by selecting one of the following options:
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <p class="info-form">
                                                                                    <ul>
                                                                                        <li>Major Alternation</li>
                                                                                        <li>Minor Alternation</li>
                                                                                        <li>Landscaping</li>
                                                                                        <li>Installation of boundary wall fence screening
                                                                                        </li>
                                                                                        <li>Installation of fly screens
                                                                                        </li>
                                                                                        <li>Installation of additional storage shelves
                                                                                        </li>
                                                                                        <li>
                                                                                            Installation of aluminum louvered shutters (for units with available niche in the carport area)
                                                                                        </li>
                                                                                        <li>Wall Cliding</li>
                                                                                        <li>Replacement of internal light fittings
                                                                                        </li>
                                                                                        <li>
                                                                                            Installation of wooden or vinyl flooring on top of existing tiles
                                                                                        </li>
                                                                                        <li>
                                                                                            Installation of CCTV Cameras</li>
                                                                                        <li>
                                                                                            Installation of Sail Sheds and awnings in the Backyardz
                                                                                        </li>
                                                                                    </ul>

                                                                                    </p>
                                                                                    <p>
                                                                                        The request for Alteration will be reviewed and an approval / decline letter will be issued thereafter.
                                                                                        Nshama reserves the right to modify the Application Type while approving the Alteration Request form.
                                                                                    </p>
                                                                                    <p>Following works are strictly prohibited and will not be permitted to be undertaken.
                                                                                    </p>
                                                                                    <ul>
                                                                                        <li>Any structural alternations / improvements that affects the external elevation and structural walls of a Townhouse / Apartment.
                                                                                        </li>
                                                                                        <li>Any alternations that prevents access to utility meters.
                                                                                        </li>
                                                                                        <li>Temporary / Permanent closure or Installation of doors to the garage.
                                                                                        </li>
                                                                                        <li>Any alternations to setback and maximum GFA fixed by relevant authorities.
                                                                                        </li>
                                                                                        <li>
                                                                                            Any alternations to property boundary walls.

                                                                                        </li>
                                                                                        <li>
                                                                                            Enclosure of any balcony
                                                                                    ...
                                                                                    <span style="font-style: italic; font-size: 14px">Once the approval letter for Alternation works is received, kindly proceed to the <strong>‘Approved Alternation – Fee Payment’</strong> section to complete the payment information.
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="alterationpurpose" maxlength="" name="alterationpurpose">
                                                                                                <option value="">--None--</option>
                                                                                                <option value="Installation Of Boundary Walls">Installation of boundary walls</option>
                                                                                            </select>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <textarea class="form-control" alt="" id="description" maxlength="" name="description">
                                                                                        </textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name:</strong> <?php echo $_SESSION['alterationrequest']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type </strong> <?php echo $_SESSION['alterationrequest']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Alteration Duration</strong> <?php echo $_SESSION['alterationrequest']['alterationduration']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Alteration Purpose</strong> <?php echo $_SESSION['alterationrequest']['alterationpurpose']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Description</strong> <?php echo $_SESSION['alterationrequest']['description']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
