...
if (isset($_POST['step_3_submit'])) {
    ...
    $sql = "INSERT INTO `residentpass`(`id`, `propertyname`, `residentpass`,`applicationtype`,`created_by`) VALUES ('','$propertyname','$residentpass', '$applicationtype','$usID')";
    ...
    header('location:residentpass.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    header('location:residentpass.php?step_new=3');
}
?>
