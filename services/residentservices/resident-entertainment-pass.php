...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['residentpass']['propertyname'];
    $residentpass = $_SESSION['residentpass']['residentpass'];
    $applicationtype = $_SESSION['residentpass']['applicationtype'];
    ...
    $sql = "INSERT INTO `residentpass`(`id`, `propertyname`, `residentpass`,`applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$residentpass', '$applicationtype','$created_date','$usID')";
    ...
    header('location:resident-entertainment-pass.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $save_to_data = array('propertyname' => $propertyname, 'residentpass' => $residentpass,  'applicationtype' => $applicationtype);
    $_SESSION['residentpass'] = $save_to_data;
    header('location:resident-entertainment-pass.php?step_new=3');
}
?>
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="../residentservices/shuttle-bus-card.php"> Resident Pass </a></li>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control" alt="" id="propertyname" maxlength="" name="propertyname">
                                                                                                ...
                                                                                                ?>
                                                                                                        ...
                                                                                                        <option <?php if (isset($_SESSION['residentpass']['propertyname'])) {
                                                                                                                    echo ($_SESSION['residentpass']['propertyname'] == $values) ? 'selected=true' : '';
                                                                                                                } ?> value="<?= $values; ?>"><?= $values ?>
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Resident Pass">Resident Pass</option>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td class="attributes_content">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type :</strong> <?php echo $_SESSION['residentpass']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>No of shuttle bus card</strong> <?php echo $_SESSION['residentpass']['residentpass']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
