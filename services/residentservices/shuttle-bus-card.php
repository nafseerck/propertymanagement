...
if (isset($_POST['step_3_submit'])) {
    ...
    $propertyname = $_SESSION['shuttlebuscard']['propertyname'];
    $shuttlebuscard = $_SESSION['shuttlebuscard']['shuttlebuscard'];
    $applicationtype = $_SESSION['shuttlebuscard']['applicationtype']; 
    ...
    $sql = "INSERT INTO `shuttlebuscard`(`id`, `propertyname`, `shuttlebuscard`, `applicationtype`,`created_at`,`created_by`) VALUES ('','$propertyname','$shuttlebuscard' , '$applicationtype','$created_date','$usID')";
    ...
    header('location:shuttle-bus-card.php?final=true#step-4');
}
...
if (isset($_POST['submit'])) {
    ...
    $shuttlebuscard = mysqli_real_escape_string($con, $_POST['shuttlebuscard']);
    $applicationtype = mysqli_real_escape_string($con, $_POST['applicationtype']);

  

    $save_to_data = array('propertyname' => $propertyname, 'shuttlebuscard' => $shuttlebuscard, 'applicationtype' => $applicationtype);
    $_SESSION['shuttlebuscard'] = $save_to_data;
    header('location:shuttle-bus-card.php?step_new=3');
}
?>
                                                                    ...
                                                                    <div class="wizard-container body current" id="" role="tabpanel" aria-labelledby="" aria-hidden="false" style="display: block;">
                                                                        <span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col">
                                                                                    <p>
                                                                                        Townsquare Shuttle Bus is an exclusive service for Townsquare Residents and Shuttles 7 days a week at regular intervals between TownSquare Dubai and Mall of Emirates. In order to use the service, Residents will need to obtain a Shuttle bus access card paying a one-time card printing fee of AED50. There is no separate charge for the rides. Card will be ready for collection within 2 working days from the date of payment.
                                                                                    </p>
                                                                                    <p>
                                                                                        Cards can be collected from Cash counter at the Townsquare Recreation Park between 1.00 p.m and 9.00 p.m on all days by showing a copy of the service confirmation email.
                                                                                    </p>

                                                                                    <p>
                                                                                        <a href="#shuttlebusschedule">Shuttle Bus Schedule</a>
                                                                                        <a href="#shuttlebusschedule">Shuttle Bus Route</a>
                                                                                    </p>
                                                                                    ...
                                                                                    <ul>
                                                                                        <li>
                                                                                            Service should be used by residents or their dependents only.
                                                                                        </li>
                                                                                        <li>
                                                                                            Nshama reserves the right to refuse entry to any person who is not registered as a resident in the community or does not follow the general guidelines.
                                                                                        </li>
                                                                                        <li>
                                                                                            Card must be scanned at every entry into the bus.
                                                                                        </li>
                                                                                        <li>
                                                                                            Children under 12 must be accompanied by an Adult
                                                                                        </li>
                                                                                        <li>
                                                                                            Pets are not allowed in the Bus
                                                                                        </li>
                                                                                        <li>
                                                                                            Eating / drinking/ littering in the bus is prohibited and community fines will apply for violations of the same.
                                                                                        </li>
                                                                                        <li>
                                                                                            The bus timings may be changed from time to time as per requirement. Any planned change in schedule/timing will be notified in advance.
                                                                                        </li>
                                                                                        <li>
                                                                                            Bus timings are approximate and may change depending of traffic conditions.
                                                                                        </li>
                                                                                        <li>
                                                                                            On move-out from the community, the card will be deactivated.
                                                                                        </li>
                                                                                        <li>
                                                                                            The card printing fees is non- refundable
                                                                                        </li>
                                                                                    </ul>
                                                                                    </p>
                                                                                </div>
                                                                            ...
                                                                            <form method="POST">
                                                                                <div>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label class="col-sm-2 control-label "> No of Shuttle Bus cards
                                                                                            <span class="red">*</span>
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select class="form-control" alt="" id="applicationtype" maxlength="" name="applicationtype">
                                                                                                <option value="Shuttle Bus Card">Shuttle Bus Card</option>
                                                                                            </select>
                                                                                        </div>
                                                                                                                                ...
                                                                                                                                <td class="attributes_content">
                                                                                                                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Property Name :</strong> <?php echo $_SESSION['shuttlebuscard']['propertyname']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>Application Type:</strong> <?php echo $_SESSION['shuttlebuscard']['applicationtype']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td class="attributes_item">
                                                                                                                                                <span class="f-fallback">
                                                                                                                                                    <strong>No of shuttle bus card</strong> <?php echo $_SESSION['shuttlebuscard']['shuttlebuscard']; ?>
                                                                                                                                                </span>
                                                                                                                                            </td>
                                                                                                                                        </tr>
