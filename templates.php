                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                                ...
                                                <div class="col-lg-6">
                                                    <nav class="navbar navbar-light bg-light justify-content-between">
                                                        <form class="form-inline">
                                                            <div class="container">
                                                                <input class="form-control" style="width: 180px;" type="search" placeholder="Search" aria-label="Search">
                                                                <button class="btn btn-outline-success my-2 my-sm-6" type="submit">Search</button>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><a href="#">Floor Plan</a>	</th>
                                                    <td>Please use this template to view all the floor plans for your properties.</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><a href="#">Floor Plan</a>	</th>
                                                    <td>Please use this template to view all the floor plans for your properties.</td>
